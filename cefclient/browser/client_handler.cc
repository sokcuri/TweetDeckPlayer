...
bool ClientHandler::OnContextMenuCommand(
	...
	case CLIENT_ID_OPEN_LINK:
		ShellExecute(NULL, L"open", params->GetLinkUrl().c_str(), 0, 0, SW_SHOWNORMAL);
		return true;
	...
	case CLIENT_ID_OPEN_IMAGE_LINK:
		ShellExecute(NULL, L"open", params->GetSourceUrl().c_str(), 0, 0, SW_SHOWNORMAL);
		return true;
...
bool ClientHandler::OnBeforePopup(
  ...
  // Cancel popup-window, open to the shell
  ShellExecute(NULL, L"open", target_url.c_str(), NULL, NULL, SW_SHOWNORMAL);
  return true;
}
